...
Tech_manager tm[n5];//技术经理（下属若干技术员）
//主函数部分：
int main()
{
	char n;
	...
	for (int i = 0; i < 1000; i++) //设定循环次数（便于各项操作的切换及方便查询）
	{
		...
		case'3': //数据打印
			system("cls");
			cout << endl << "您所选操作为数据输出，请继续——" << endl << endl;
			data_print();
			cout << endl << endl;
			cout << '\a' << "——数据输出完毕——" << '\n' << '\n' << endl;
			menu();
...
void menu() //菜单函数
{
	...
	cout << "\033[0;34m|                                                                     |\033[0m" << endl;
	cout << "\033[0;34m|---------------------------------------------------------------------|\033[0m" << endl;
	cout << "\033[0;34m|          \033[0;36m  【1】数据输入           【2】数据统计       \033[0;34m             |\033[0m" << endl;
	cout << "\033[0;34m|           \033[0;36m 【3】数据输出           【4】数据查询       \033[0;34m             |\033[0m" << endl;
	cout << "\033[0;34m|          \033[0;36m  【5】退出系统                             \033[0;34m               |\033[0m" << endl;
	cout << "\033[0;34m+=====================================================================+\033[0m" << endl;
	cout << endl;
	cout << "操作提示：输入编号并按回车键选择你想实现的功能\n" << endl;
	cout << " 请选择一个操作:";
}
void menu2() //数据输入二级菜单函数
{
	...
	cout << "\033[0;34m|                                                                     |\033[0m" << endl;
	cout << "\033[0;34m|---------------------------------------------------------------------|\033[0m" << endl;
	cout << "\033[0;34m|          \033[0;36m  【1】经理数据输入           【2】技术人员数据输入       \033[0;34m |\033[0m" << endl;
	cout << "\033[0;34m|           \033[0;36m 【3】销售员数据输入         【4】销售经理数据输入      \033[0;34m  |\033[0m" << endl;
	cout << "\033[0;34m|          \033[0;36m  【5】技术经理数据输入       【6】返回上一级             \033[0;34m |\033[0m" << endl;
	cout << "\033[0;34m+=====================================================================+\033[0m" << endl;
	cout << endl;
	cout << "操作提示：输入编号并按回车键选择你想实现的功能\n" << endl;
	cout << " 请选择一个操作:";
...
void menu3() //数据打印二级菜单函数
{
	...
	cout << "\033[0;34m|                                                                     |\033[0m" << endl;
	cout << "\033[0;34m|---------------------------------------------------------------------|\033[0m" << endl;
	cout << "\033[0;34m|          \033[0;36m  【1】经理数据输出           【2】技术人员数据输出      \033[0;34m  |\033[0m" << endl;
	cout << "\033[0;34m|           \033[0;36m 【3】销售员数据输出         【4】销售经理数据输出      \033[0;34m  |\033[0m" << endl;
	cout << "\033[0;34m|          \033[0;36m  【5】技术经理数据输出       【6】返回上一级            \033[0;34m  |\033[0m" << endl;
	cout << "\033[0;34m+=====================================================================+\033[0m" << endl;
	cout << endl;
	cout << "操作提示：输入编号并按回车键选择你想实现的功能\n" << endl;
	cout << " 请选择一个操作:";
...
void statistics() //数据统计函数
{
	...
	for (i = 0; i < n5; i++)
	{
		cout << endl << "职工号为 " << tm[i].tm_number() << " 技术经理 " << tm[i].tm_name()
			<< " 下属技术员的业绩为:" << endl << endl;
		double sum = 0;
		charthead3();
		for (j = 0; j < n1; j++)
